...
Implements eight subcommands described under [`docs/`](docs/):
...
| `jkit conflicts`  | DTO ↔ Entity drift: type mismatches and validation gaps via tree-sitter-java (used by `/migrate-project`) |
